...
#pragma HLS dataflow
    ...
    float prev_buffer_11_1[FEATURES/2048];
    float prev_buffer_11_2[FEATURES/2048];
    ...
    float prev_buffer_12_1[FEATURES/4096];
    float prev_buffer_12_2[FEATURES/4096];
    ...
    float prev_buffer_13_1[FEATURES/8192];
    float prev_buffer_13_2[FEATURES/8192];
    ...
    float prev_buffer_14_1[FEATURES/16384];
    float prev_buffer_14_2[FEATURES/16384];
